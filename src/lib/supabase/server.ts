 ...
 * ⚠️ ONLY use for trusted server-side operations (sync, admin tasks)
 */
export function createServiceRoleClient() {
  ...
  if (!supabaseUrl || !serviceRoleKey) {
    throw new Error('Supabase service role credentials are missing. Set SUPABASE_SERVICE_ROLE_KEY.')
  }
